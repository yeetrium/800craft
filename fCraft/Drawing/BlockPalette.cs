       ...
       const double LinearThreshold = (6/29d)*(6/29d)*(6/29d),
        ...
        static BlockPalette DefineLight() {
            return new BlockPalette( "Light", 1 ) {
                ...
                {RgbColor.FromArgb( 126, 92, 63 ), new[] {Block.Brown}},
                ...
                {RgbColor.FromArgb( 224, 109, 167 ), new[] {Block.LightPink}},
        ...
        static BlockPalette DefineDark() {
            return new BlockPalette( "Dark", 1 ) {
                ...
                {RgbColor.FromArgb( 84, 62, 43 ), new[] {Block.Brown}},
                ...
                {RgbColor.FromArgb( 222, 70, 146 ), new[] {Block.LightPink}},
